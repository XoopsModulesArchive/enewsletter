...
$modversion['author'] = 'Xoops Port By Brian Wahoff, modified by Hervé Thouzard and Updated By Catzwolf and EVUCAN';
$modversion['help'] = 'help.html';
$modversion['license'] = 'GPL see LICENSE';
$modversion['official'] = 0;
$modversion['image'] = 'images/logo.png';
$modversion['dirname'] = 'enewsletter';
...
$modversion['tables'][0] = "enewsletter_maillists";
$modversion['tables'][1] = "enewsletter_members";
$modversion['tables'][2] = "enewsletter_messages";

// Templates
$modversion['templates'][1]['file'] = 'enewsletter_index.html';
$modversion['templates'][1]['description'] = _MI_EVENNEWS_TEMPINDEX;
$modversion['templates'][2]['file'] = 'enewsletter_subscr.html';
$modversion['templates'][2]['description'] = _MI_EVENNEWS_TEMPSUBSC;
$modversion['templates'][3]['file'] = 'enewsletter_notice.html';
$modversion['templates'][3]['description'] = _MI_EVENNEWS_TEMPNOTICE;
$modversion['templates'][4]['file'] = 'enewsletter_archive.html';
$modversion['templates'][4]['description'] = _MI_EVENNEWS_TEMPARCHIVE;
$modversion['templates'][5]['file'] = 'enewsletter_message.html';
$modversion['templates'][6]['description'] = _MI_EVENNEWS_TEMPMESSAGE;

// Blocks
$modversion['blocks'][1]['file'] = "enewsletter_blocks.php";
$modversion['blocks'][1]['name'] = _MI_EVENNEWS_BNAME1;
$modversion['blocks'][1]['description'] = "Allow users to subscribe or unsubscribe";
$modversion['blocks'][1]['show_func'] = "b_enewsletter_subscr";
$modversion['blocks'][1]['options'] = "";
$modversion['blocks'][1]['edit_func'] = "";
$modversion['blocks'][1]['template'] = 'enewsletter_block_subcr.html';
